...
class MTView(ctk.CTkFrame):
    def __init__(self, master):
        ...
        # =====================================================================
        # 1. SIDEBAR LATERALE (Indice anomalie MT)
        # =====================================================================
        ...
        self.search_entry = ctk.CTkEntry(
            self.search_frame,
            placeholder_text="🔍 Cerca errore o procedura nell'app MT...",
            height=38,
        ...
        self.title_label = ctk.CTkLabel(
            self.content_card, 
            text="Seleziona una segnalazione MT", 
        ...
        self.desc_label = ctk.CTkLabel(
            self.content_card, 
            text="Usa l'indice o la barra di ricerca per visualizzare le soluzioni di MT.",
            font=Stile.FONT_NORMALE, 
        ...
        # Estrazione dinamica degli stili di stato semantici dal file di stile
        ...
        # CONTENITORE COMPONENTI DI RISOLUZIONE
        self.steps_frame = ctk.CTkScrollableFrame(
            self.content_card, 
            label_text="📌 RISOLUZIONE PROBLEMA METODO",
    ...
    def aggiorna_dettagli(self, titolo, descrizione, soluzioni):
        ...
        for i, sol in enumerate(soluzioni, 1):
            ...
            # Calcolo corretto del wraplength tenendo conto della larghezza fissa (80) del badge PASSAGGIO
            step_container.bind("<Configure>", lambda e, l=lbl_testo: l.configure(wraplength=max(200, e.width - 110)))
