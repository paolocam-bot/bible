...
class ManualeView(ctk.CTkFrame):
    def __init__(self, master):
        ...
        # Configurazione Layout Responsivo (Sidebar fissa, Contenuto flessibile)
        self.grid_columnconfigure(1, weight=1)
        self.grid_rowconfigure(0, weight=1)

        # 1. SIDEBAR LATERALE (Indice argomenti)
        ...
        # 2. AREA PRINCIPALE DI CONTENUTO
        self.main_area = ctk.CTkFrame(self, fg_color="transparent")
        self.main_area.grid(row=0, column=1, sticky="nsew")
        self.main_area.grid_columnconfigure(0, weight=1)
        
        # IMPORTANTE: riga 0 (ricerca) fissa, riga 1 (scheda) si espande
        ...
        self.search_entry = ctk.CTkEntry(
            self.search_frame,
            placeholder_text="🔍 Cerca argomento nel manuale...",
            height=38
        )
        ...
        # PANNELLO CONTENUTI (SCHEDINA DETTAGLIATA)
        ...
        self.desc_label = ctk.CTkLabel(
            self.content_card,
            text="Usa la barra superiore o seleziona una voce dall'indice.",
        ...
        self.steps_frame = ctk.CTkScrollableFrame(
            self.content_card, 
            label_text="📌 FASI OPERATIVE DI RISOLUZIONE",
            label_font=ctk.CTkFont(size=12, weight="bold"),
            label_text_color=("#1f538d", "#a9cde2"),
    ...
    def popola_sidebar(self, lista_problemi, on_button_click_callback):
        # Svuota la sidebar prima di ripopolarla
        ...
        for prob in lista_problemi:
            ...
            lbl_testo = ctk.CTkLabel(
                ...
                anchor="w",
                wraplength=230,
                cursor="hand2"  # <-- Ottimizzazione: la manina compare anche sul testo
            )
            lbl_testo.pack(fill="both", expand=True, padx=10, pady=5)

            # Binding esplicito per evitare problemi di propagazione degli eventi Tkinter
    ...
    def aggiorna_dettagli(self, titolo, descrizione, soluzioni):
        ...
        for i, sol in enumerate(soluzioni, 1):
            ...
            # Corretto l'aggiornamento dinamico del testo dentro i box delle soluzioni
