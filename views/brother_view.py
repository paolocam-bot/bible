...
class BrotherView(ctk.CTkFrame):
    def __init__(self, master):
        ...
        # =====================================================================
        # 1. SIDEBAR INTERNA (Indice guasti Brother)
        # =====================================================================
        ...
        self.title_label = ctk.CTkLabel(
            self.content_card, 
            text="Seleziona una problematica Brother", 
        ...
        self.desc_label = ctk.CTkLabel(
            self.content_card, 
            text="Usa la barra superiore o seleziona un guasto dall'indice a sinistra.",
            font=Stile.FONT_NORMALE, 
        ...
        # Estrazione dinamica degli stili semantici di stato
        ...
        self.btn_add = ctk.CTkButton(
            ...
            hover_color=("#198754", "#0f5132"), # Hover verde coordinato chiaro/scuro
        ...
        self.btn_delete = ctk.CTkButton(
            ...
            hover_color=("#dc3545", "#842029"), # Hover rosso coordinato chiaro/scuro
            text_color=colore_testo_del,
            corner_radius=Stile.CORNER_RADIUS_INPUT
        )
        self.btn_delete.pack(side="left", padx=5)

        # SCHEDA FASI DI RIPRISTINO
        self.steps_frame = ctk.CTkScrollableFrame(
            self.content_card, 
            label_text="📌 FASI DI RIPRISTINO STAMPANTE",
    ...
    def popola_sidebar(self, lista_problemi, on_button_click_callback):
        ...
        # Colore hover per gli elementi della lista coerente con il tema attivo
    ...
    def aggiorna_dettagli(self, titolo, descrizione, soluzioni):
        ...
        # Generazione dei badge STEP usando lo stato centrale "in attesa"
